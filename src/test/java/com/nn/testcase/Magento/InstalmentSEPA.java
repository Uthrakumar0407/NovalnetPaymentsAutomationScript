...
import static com.nn.Magento.Constants.COMPLETION_ORDER_STATUS;
...
public class InstalmentSEPA extends BaseTest {
    ...
    public void setUpGlobalConfiguration() {
        ...
        updateProductStock(PRODUCT_INSTALLMENT_SEPA);
    ...
    public void firstOrder(){
        ...
        magentoPage.getOrderPage().proceedInstalmentRefund(cycleAmount,INSTALMENT_SEPA_BOOKBACK);
    }
    ...
    public void secondOrder(){
        ...
        refundPartialViaShopBackend(orderNumber,cycleAmount,PROCESSING_ORDER_STATUS,INSTALMENT_SEPA_BOOKBACK);
    }
    ...
    public void fifthOrder(){
        magentoPage.getNovalnetAdminPortal().openNovalnetAdminPortal();
        magentoPage.getNovalnetAdminPortal().loadAutomationProject();
        String productAmount = getProductPrice(PRODUCT_INSTALLMENT_SEPA);
        setPaymentConfiguration(INSTALMENT_DIRECT_DEBIT_SEPA, Map.of(
                TESTMODE,true,
                PAYMENT_ACTION,AUTHORIZE,
    ...
    public void seventhOrder(){
        ...
        magentoPage.getCheckoutPage().load().openCheckoutPage()
                .isPaymentMethodDisplayed(INSTALMENT_DIRECT_DEBIT_SEPA)
                .fill_InstalmentSEPA_IBAN(magentoPage.getTestData().get("IBANDE"))
                .verifyInstalmentSepaDateOfBirthDisplayed(false)
                .selectInstalmentSepaCycle(3)
                .clickPlaceOrderBtnForSepa();
        magentoPage.getSuccessPage().verifyNovalnetCommentsDisplayed();
        magentoPage.getTxnInfo().putAll(magentoPage.getSuccessPage().getSuccessPageTransactionDetails());
    ...
    public void eleventhOrder(){
        ...
        magentoPage.getOrderPage().instalmentCancel(cycleAmount,INSTALMENT_SEPA_BOOKBACK);
    }
    ...
    public void guaranteeValidation1(){
        ...
        magentoPage.getCheckoutPage()
                ...
                .fill_InstalmentSEPA_IBAN(magentoPage.getTestData().get("IBANDE"))
                .selectInstalmentSepaCycle(3)
                .fill_DOB_InstalmentSEPA(DOB_LESS_18)
    ...
    public void guaranteeValidation10(){
        ...
        navigateCheckout(MagentoAPIs.getCustomerEmail());
        magentoPage.getCheckoutPage()
                .isPaymentDisplayed(INSTALMENT_DIRECT_DEBIT_SEPA,false); // DIFF_BILLING_SHIPPING
    }
    ...
    public void mailVerifyOrder(){
        ...
        createCustomer(INSTALMENT_DIRECT_DEBIT_SEPA,"automation_test@novalnetsolutions.com");
        addProductToCart(PRODUCT_INSTALLMENT_SEPA,1);
        magentoPage.getShopUserLoginPage().SigninToShop(MagentoAPIs.getCustomerEmail(),SHOP_FRONTEND_PASSWORD);
    ...
    //@Test(priority = 23, description = "Verify that instalment sepa payment is hidden on the checkout page when payment id disabled in admin portal")
